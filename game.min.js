...
ig.baked=true;ig.module('game.entities.Nube').requires('impact.entity').defines(function(){EntityNube=ig.Entity.extend({zIndex:999,init:function(x,y,settings){this.addAnim('idle',1,[0]);this.parent(x,y,settings);},update:function(){this.parent();}});});

// lib/game/entities/Nube01.js
ig.baked=true;ig.module('game.entities.Nube01').requires('game.entities.Nube').defines(function(){EntityNube01=EntityNube.extend({name:'Nube01',size:{x:369,y:165},animSheet:new ig.AnimationSheet('media/nube01.png',369,165)});});

// lib/game/entities/Nube02.js
ig.baked=true;ig.module('game.entities.Nube02').requires('game.entities.Nube').defines(function(){EntityNube02=EntityNube.extend({name:'Nube02',size:{x:387,y:160},animSheet:new ig.AnimationSheet('media/nube02.png',387,160)});});

// lib/game/entities/Nube03.js
ig.baked=true;ig.module('game.entities.Nube03').requires('game.entities.Nube').defines(function(){EntityNube03=EntityNube.extend({name:'Nube03',size:{x:386,y:168},animSheet:new ig.AnimationSheet('media/nube03.png',386,168)});});

// lib/game/entities/Nube04.js
ig.baked=true;ig.module('game.entities.Nube04').requires('game.entities.Nube').defines(function(){EntityNube04=EntityNube.extend({name:'Nube04',size:{x:507,y:236},animSheet:new ig.AnimationSheet('media/nube04.png',507,236)});});

// lib/game/entities/Nube05.js
ig.baked=true;ig.module('game.entities.Nube05').requires('game.entities.Nube').defines(function(){EntityNube05=EntityNube.extend({name:'Nube05',size:{x:456,y:202},animSheet:new ig.AnimationSheet('media/nube05.png',456,202)});});

// lib/game/entities/Pajaro.js
ig.baked=true;ig.module('game.entities.Pajaro').requires('impact.entity').defines(function(){EntityPajaro=ig.Entity.extend({name:'Pajaro',size:{x:290,y:276},zIndex:999,animSheet:new ig.AnimationSheet('media/pajaro.png',290,276),init:function(x,y,settings){this.addAnim('idle',1,[0]);this.addAnim('fly',0.3,[1,2,0]);this.vel.x=40;this.vel.y=10;this.parent(x,y,settings);},update:function(){this.parent();if(this.pos.x>ig.game.screen.x+ig.system.realWidth){}
...
ig.baked=true;ig.module('game.entities.Pez').requires('impact.entity').defines(function(){EntityPez=ig.Entity.extend({zIndex:999,init:function(x,y,settings){this.addAnim('idle',1,[0]);this.parent(x,y,settings);},update:function(){this.parent();}});});
