...
.defines(function(){
	...
	MyGame = ig.Game.extend({
		...
		init: function() {
        	...
        	ig.input.bind( ig.KEY.S, 'settings' );
	...
	SettingsGame = ig.Game.extend({
		...
		init: function(){
			...
			this.buttons = new ig.TouchButtonCollection([
	                ...
	                new ig.TouchButton( 'aceptar', {left:1850, top: 1450}, 60, 60, this.buttonOkImage,0,1,0 ),
	                new ig.TouchButton( 'cancelar', {left:40, top: 1450}, 60, 60, this.buttonCancelImage,0,1,0 ),
	            ]);
		...
		draw: function(){
			...
			ig.system.context.fillText(i18n.t("preferencias.aceptar"), 1780, 1450);
