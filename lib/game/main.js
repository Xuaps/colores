...
.defines(function(){
	...
	PaintGame = ig.Game.extend({
		...
		init: function(){
			...
			var red=new ig.CheckTouchButton( "red", {left:120, bottom: 30}, 92, 92, this.buttonRedImage,1,0,true);
			var orange=new ig.CheckTouchButton( "orange", {left:212, bottom: 30}, 92, 92, this.buttonOrangeImage,1,0,false);
			var yellow=new ig.CheckTouchButton( "yellow", {left:304, bottom: 30}, 92, 92, this.buttonYellowImage,1,0,false);
			var green=new ig.CheckTouchButton( "green", {left:396, bottom: 30}, 92, 92, this.buttonGreenImage,1,0,false);
			var blue=new ig.CheckTouchButton( "blue", {left:488, bottom: 30}, 92, 92, this.buttonBlueImage,1,0,false);
			var indigo=new ig.CheckTouchButton( "indigo", {left:580, bottom: 30}, 92, 92, this.buttonIndigoImage,1,0,false);
			var violet=new ig.CheckTouchButton( "violet", {left:672, bottom: 30}, 92, 92, this.buttonVioletImage,1,0,false);
			var eraser=new ig.CheckTouchButton( "eraser", {left:764, bottom: 30}, 92, 92, this.buttonEraserImage,1,0,false);
			...
			this.buttons = new ig.TouchButtonCollection([
                ...
                new ig.TouchButton( 'left', {left: 45, bottom: 50}, 30, 30, this.buttonBackImage, 0 ),
                new ig.TouchButton( 'settings', {left: 45, top: 50}, 30, 30, this.buttonSettingsImage, 0 ),
                new ig.TouchButton( 'twitter', {right: 45, top: 50}, 30, 30, this.buttonTwitterImage, 0 ),
			]);
