...
.defines(function(){
	...
	MyGame = ig.Game.extend({
		...
		draw: function() {
			...
			ig.system.context.font = '40pt Garamond-Bold';
			if(this.levels[this.currentLevel].name==="LevelRespuesta"){
				ig.system.context.fillStyle="#000000";
				this.print(i18n.t(this.levels[this.currentLevel].name+".correcto"), 1536, 1152, 60 );
			}else if(this.levels[this.currentLevel].name==="LevelTodos"){

			}else{
				ig.system.context.fillStyle="#000000";
				this.print(i18n.t(this.levels[this.currentLevel].name+".presentacion"), 512, 1088, 60);
				ig.system.context.fillStyle="#FFFFFF";
				this.print(i18n.t(this.levels[this.currentLevel].name+".frase"), 1536,
					(this.levels[this.currentLevel].name!=="LevelAmarillo")?80:1088, 60);
			}
		},
