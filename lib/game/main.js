	...
	MyGame = ig.Game.extend({
		...
		init: function() {
            ...
            this.buttons = new ig.TouchButtonCollection([
                new ig.TouchButton( 'right', {right: 90, bottom: 100}, 30, 30, this.buttonNextImage, 0 ),
                new ig.TouchButton( 'left', {left: 90, bottom: 100}, 30, 30, this.buttonBackImage, 0 ),
                new ig.TouchButton( 'settings', {left: 90, top: 100}, 30, 30, this.buttonSettingsImage, 0 ),
            ]);
		...
		draw: function() {
			...
			if(this.levels[this.currentLevel].name==="LevelRespuesta"){
				...
				this.print(i18n.t(this.levels[this.currentLevel].name+".correcto"), 1536, 1152, 20 );
			}else if(this.levels[this.currentLevel].name==="LevelTodos"){

			}else{
				ig.system.context.fillStyle="#000000";
				this.print(i18n.t(this.levels[this.currentLevel].name+".presentacion"), 256, 544, 20);
				ig.system.context.fillStyle="#FFFFFF";
				this.print(i18n.t(this.levels[this.currentLevel].name+".frase"), 768,
					(this.levels[this.currentLevel].name!=="LevelAmarillo")?40:544, 60);
			}
		},
