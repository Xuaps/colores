	...
	CreditsGame = ig.Game.extend({
		...
		update: function(){
			...
			if(ig.input.pressed('aceptar')){
				...
				this.openUrl('mailto:tales@xuaps.com?Subject='+i18n.t("Home.titulo"));
				...
				this.openUrl('mailto:carloscomendador@gmail.com?Subject='+i18n.t("Home.titulo"));
				...
				this.openUrl('mailto:irene@entrelinguas.eu?Subject='+i18n.t("Home.titulo"));
			}
		},
