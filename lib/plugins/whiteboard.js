...
.defines(function(){ "use strict";
	...
	window.WhiteBoard = ig.Class.extend({
		...
		init: function(drawingAreaX, drawingAreaY, drawingAreaWidth, drawingAreaHeight){
			...
			ig.system.canvas.addEventListener("mousedown", this._press.bind(this), false);
			ig.system.canvas.addEventListener("mousemove", this._drag.bind(this), false);
			ig.system.canvas.addEventListener("mouseup", this._release.bind(this));
			ig.system.canvas.addEventListener("mouseout", this._cancel.bind(this), false);
