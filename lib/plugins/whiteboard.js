...
.defines(function(){ "use strict";
	...
	window.WhiteBoard = ig.Class.extend({
		...
		init: function(drawingAreaX, drawingAreaY, drawingAreaWidth, drawingAreaHeight){
			...
			ig.system.canvas.addEventListener("pointerdown", this._press.bind(this), false);
			ig.system.canvas.addEventListener("pointermove", this._drag.bind(this), false);
			ig.system.canvas.addEventListener("pointerup", this._release.bind(this));
			ig.system.canvas.addEventListener("pointerout", this._cancel.bind(this), false);

			// Add touch event listeners to canvas element
			ig.system.canvas.addEventListener("touchstart", this._press.bind(this), false);
			ig.system.canvas.addEventListener("touchmove", this._drag.bind(this), false);
			ig.system.canvas.addEventListener("touchend", this._release.bind(this), false);
			ig.system.canvas.addEventListener("touchcancel", this._cancel.bind(this), false);
		},
